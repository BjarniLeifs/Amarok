...
public class PlayGame {
	...
	if(checkHorizontalforX(board) || checkHorizontalforO(board) || checkVerticalforX(board) || checkVerticalforO(board) || checkDiagnal(board) || chechInvDiagnal(board)) return true;
	return false; 
    }
